            ...
            <div class="profile-detail-wrapper">
              ...
              <div class="profile-detail-container">
                ...
                <?php if (isset($errors) && isset($errors['password'])) : ?>
                  <input type="password" name="password" id="password" class="form-input error" placeholder="Masukkan Password Lama" required>
                  <p class="input-error"><?= $errors['password'] ?></p>
                <?php else : ?>
                  <input type="password" name="password" id="password" class="form-input" placeholder="Masukkan Password Lama">
                <?php endif ?>
              </div>
