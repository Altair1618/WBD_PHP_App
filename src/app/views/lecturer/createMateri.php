  ...
  <div class="body-container">
    <main id="body-main-container" class="body-main-container">
      ...
      <div class="main-flex-container">
        <form class="form-container" action="/courses/<?=$params['course-id']?>/modules/<?=$params['modul-id']?>/create" method="POST" enctype="multipart/form-data">
          <section class="materi-detail-section">
            <div class="materi-detail-wrapper">
              ...
              <div class="materi-detail-container">
                ...
                <input type="text" value="<?php if (isset($_SESSION['post']['judulTopik'])) echo $_SESSION['post']['judulTopik']; ?>" name="judulTopik" id="judulTopik" class="form-input" placeholder="Masukkan Judul Topik Materi" required>
              </div>
              ...
              <div class="materi-detail-container">
                ...
                ?>
                <input type="file" name="video" id="video" accept="video/*" class="form-input" required>
                <?=$error?>
              </div>
            </div>
