  ...
  <div class="body-container">
    <main id="body-main-container" class="body-main-container">
      ...
      <div class="main-flex-container">
        <form class="form-container" action="/courses/<?=$params['course-id']?>/modules/create" method="POST" enctype="multipart/form-data">
          <section class="modul-detail-section">
            <div class="modul-detail-wrapper">
              <div class="modul-detail-container">
                ...
                <input type="text" value="<?=$params['course-id']?>" name="kode" id="kode" class="form-input" readonly>
              </div>

              <div class="modul-detail-container">
                <label for="name" class="modul-label">Nama</label>
                <input type="text" value="<?php if (isset($_SESSION['post']['name'])) echo $_SESSION['post']['name']; ?>" name="name" id="name" class="form-input" placeholder="Masukkan Nama Modul" required>
              </div>

              <div class="modul-detail-container">
                <label for="deskripsi" class="modul-label">Deskripsi</label>
                <input type="text" value="<?php if (isset($_SESSION['post']['deskripsi'])) echo $_SESSION['post']['deskripsi']; ?>" name="deskripsi" id="deskripsi" class="form-input" placeholder="Masukkan Deskripsi Modul">
              </div>
            </div>
